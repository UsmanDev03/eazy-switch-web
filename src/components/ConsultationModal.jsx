                ...
                <form className="space-y-3 md:space-y-4" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                      <label className="block text-[9px] md:text-[10px] font-semibold text-purple-200 uppercase tracking-wider">First Name *</label>
                      <input type="text" className="w-full p-2 md:p-2.5 rounded bg-white text-gray-900 text-sm outline-none" required />
                    </div>
                    <div className="space-y-1">
                      <label className="block text-[9px] md:text-[10px] font-semibold text-purple-200 uppercase tracking-wider">Last Name *</label>
                      <input type="text" className="w-full p-2 md:p-2.5 rounded bg-white text-gray-900 text-sm outline-none" required />
                    </div>
                  </div>
                  
                  <div className="space-y-1">
                    <label className="block text-[9px] md:text-[10px] font-semibold text-purple-200 uppercase tracking-wider">Email *</label>
                    <input type="email" className="w-full p-2 md:p-2.5 rounded bg-white text-gray-900 text-sm outline-none" required />
                  </div>

                  <div className="space-y-1">
                    <label className="block text-[9px] md:text-[10px] font-semibold text-purple-200 uppercase tracking-wider">Phone Number *</label>
                    <input type="tel" className="w-full p-2 md:p-2.5 rounded bg-white text-gray-900 text-sm outline-none" required />
                  </div>

                  <div className="space-y-1">
                    <label className="block text-[9px] md:text-[10px] font-semibold text-purple-200 uppercase tracking-wider">Company Name *</label>
                    <input type="text" className="w-full p-2 md:p-2.5 rounded bg-white text-gray-900 text-sm outline-none" required />
                  </div>

                  <motion.button 
                    whileTap={{ scale: 0.98 }}
                    className="mt-4 w-full md:w-auto bg-[#38b2ac] hover:bg-[#2c8d88] text-white font-bold py-2.5 md:py-3 px-10 rounded-full text-sm transition-all shadow-lg"
                  >
                    Check my setup
                  </motion.button>
                </form>
