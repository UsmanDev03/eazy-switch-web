        ...
        <>
          ...
          >
              ...
              <ul className="space-y-3">
                {navItems.map((item) => (
                  <li 
                    ...
                    onMouseLeave={() => item.isDropdown && setServicesOpen(false)}
                  >
                    {item.isDropdown ? (
                      ...
                      >
                        <span className="text-base font-bold text-[#1a4d4d]">{item.label}</span>
            ...
            <div className="p-6 space-y-6 bg-white/20 border-t border-white/30">
              <button
                onClick={() => { onClose(); if (setIsModalOpen) setIsModalOpen(true); }}
