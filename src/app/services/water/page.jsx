    ...
    <div className="min-h-screen bg-[#fcfdfd] text-[#1a4d4d]">
      ...
      >
        <div className="relative bg-[#1a4d4d] min-h-[55vh] flex items-center justify-center">
          {/* Next.js Optimized Background Image for Water Costs */}
          <div className="absolute inset-0 z-0 bg-[#1a4d4d]">
            <Image
              ...
              alt="Commercial Water Management Infrastructure"
              fill
              priority
              ...
              quality={90}
            />
            {/* Refined Gradient Overlay - Matches Solar Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#1a4d4d] leading-tight">
                The Cost of <br />
                <span className="text-[#8dae39]">Inaccuracy.</span>
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                Water bills often include clean water, wastewater, and drainage
                fees that can be incorrectly applied. Even minor inaccuracies
                can accumulate over time, significantly affecting your overall
                utility spend.
              </p>
              ...
              <div className="flex items-start gap-4 p-5 bg-[#8dae39]/5 rounded-2xl border border-[#8dae39]/20 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 italic">
                    Incorrect meter sizes or surface water bands are common
                    reasons for overpaying.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 container mx-auto px-6 max-w-4xl text-center">
        <div className="bg-white rounded-[3rem] p-12 shadow-xl border border-gray-100">
          <h2 className="text-3xl font-black text-[#1a4d4d] mb-6">
            Accurate Management, Real Savings.
          </h2>
