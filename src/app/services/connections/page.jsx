...
const ConnectionsPage = () => {
  const connectionServices = [
    { label: "New Site Setup", desc: "Coordinating gas, electric, and water feeds" },
    { label: "Capacity Expansions", desc: "Upgrading supply for business growth" },
    { label: "Meter Registration", desc: "Ensuring accurate data from day one" },
    { label: "Infrastructure", desc: "Liaising with network operators (DNO/IGT)" },
    { label: "Project Coordination", desc: "Timely energisation and supply setup" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#fcfdfd] text-[#1a4d4d]">
      ...
      {/* Hero Section - 55vh Height & Same Style */}
      <section
      ...
      >
        <div className="relative bg-[#1a4d4d] min-h-[55vh] flex items-center justify-center">
          <div className="container mx-auto px-6 pt-28 pb-16 md:pt-36 md:pb-20 text-center relative z-10">
            ...
            >
              From new site setups to infrastructure expansions, we handle the complexity 
              of utility registrations. Guiding your project with{" "}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-black text-[#1a4d4d] leading-tight">
                Preventing <br /><span className="text-[#8dae39]">Project Delays.</span>
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                Incorrect applications or registration errors can cause long-term supply 
                problems and billing issues from day one. Properly managed connections 
                ensure your business stays on track.
              </p>
      ...
      <section className="py-20 bg-[#1a4d4d] relative overflow-hidden">
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-white mb-4">How We Help.</h2>
            <p className="text-[#8dae39] font-medium text-lg">Independent Utility Consultancy</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-[2rem] hover:bg-white/10 transition-all group text-center">
                <box.icon className="w-12 h-12 text-[#8dae39] mx-auto mb-6 group-hover:scale-110 transition-transform" />
                <h4 className="text-white font-bold mb-3 text-lg">{box.title}</h4>
      ...
      <section className="py-20 container mx-auto px-6 max-w-4xl text-center">
        <div className="bg-white rounded-[3rem] p-12 shadow-xl border border-gray-100">
          <h2 className="text-3xl font-black text-[#1a4d4d] mb-6">Smooth Projects, Reliable Setup.</h2>
